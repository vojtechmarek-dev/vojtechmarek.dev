<script lang="ts">
    ...
    let { open, overlayId, onCloseMenu } = $props<{
        open: boolean;
        overlayId: string;
        onCloseMenu: () => void;
    }>();
...
{#if open}
    ...
    >
        <div
            ...
            out:fade={{ duration: 200 }}
        ></div>
        <div class="panel" in:fly={{ x: -40, duration: 600, easing: cubicOut }} out:fly={{ x: -40, duration: 500, easing: cubicOut }}>
            <div class="panel-top">
