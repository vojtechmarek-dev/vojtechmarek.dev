<script lang="ts">
    ...
    import { calculateYearsSince } from '$lib/utils/dates';
...
<ul class="resume-contact">
    <li class="birthday">
        <span class="icon"><WatchIcon /></span>
        <span>{calculateYearsSince(new Date('1996-04-03'))} years old</span>
    </li>
    <li class="experience">
        <span class="icon"><SuitcaseIcon /></span>
        <span>
    ...
    <li class="linkedin">
        ...
        <a href="https://www.linkedin.com/in/vojtechmarek-dev/" target="_blank" rel="noopener noreferrer"> LinkedIn Profile </a>
    </li>
    <li class="website">
    ...
    <li class="github">
        ...
        <a href="https://github.com/vojtechmarek-dev" target="_blank" rel="noopener noreferrer"> GitHub Profile </a>
    </li>
    <li class="languages">
        <span class="icon"><GlobeIcon /></span>
        <span>Czech, English</span>
    </li>
</ul>
