...
<article class="resume">
    ...
    <section class="about">
        ...
        <p>
            I am a <b>Full-Stack Developer</b> with a primary focus on <b>Front-End</b> technologies. While I am proficient in <b>Java</b> and
            <b>Spring</b>, my true passion lies in building accessible and performant user interfaces using <b>Angular</b>, <b>Svelte</b> or (if
            needed) <b>React</b>.
        </p>
        <br />
        <p>
            I also have practical experience in <b>DevOps</b>, enabling me to confidently manage review and deploy <b>Docker</b> containers,
            <b>Ansible</b>
            playbooks, and <b>Linux</b> environments. Additionally, my background as a <b>Scrum Master</b> has helped me build strong collaboration
            skills and become a reliable <b>team player</b>.
        </p>
    </section>
    <section class="work">
